 ...
 <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border px-6 py-6">
   ...
   <form action="{{ route('pinjambarang.update', $pinjambarang->id) }}" method="POST">
     ...
     <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base/7 font-semibold text-gray-900">Edit Pinjam barang Data</h2>
        ...
        <div class="mt-5 col-span-full gap-y-8">
          ...
          <div class="mt-2">
            <textarea id="tgl_pinjam" name="tgl_pinjam" rows="3" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">{{ old('tgl_pinjam', $pinjambarang->tgl_pinjam) }}</textarea>
          </div>
        </div>
        ...
        <div class="mt-5 col-span-full gap-y-8">
            ...
            <div class="mt-2">
              <input id="id_barang" name="id_barang" type="text" value="{{ old('id_barang', $pinjambarang->id_barang) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
            </div>
          </div>
        </div>
        ...
        <div class="mt-5 col-span-full gap-y-8">
          ...
          <div class="mt-5 col-span-full gap-y-8">
            ...
            <div class="mt-2">
              <input id="jml_barang" name="jml_barang" type="text" value="{{ old('jml_barang', $pinjambarang->nama_barang) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
            </div>
          </div>
          ...
          <div class="mt-5 col-span-full gap-y-8">
            ...
            <div class="mt-2">
              <input id="tgl_kembali" name="tgl_kembali" type="text" value="{{ old('tgl_kembali', $pinjambarang->tgl_kembali) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
            </div>
          </div>
          ...
          <div class="mt-5 col-span-full gap-y-8">
            ...
            <div class="mt-2">
              <input id="kondisi" name="kondisi" type="text" value="{{ old('kondisi', $pinjambarang->kondisi) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
            </div>
          </div>
