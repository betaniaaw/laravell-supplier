                ...
                <label for="jml_barang" class="block text-sm/6 font-medium text-gray-900">Jumlah barang</label>
                  ...
                  <div class="mt-5 col-span-full gap-y-8">
                    <label for="tgl_kembali" class="block text-sm/6 font-medium text-gray-900">Tanggal kembali</label>
                      <div class="mt-2">
                        <input id="tgl_kembali" name="tgl_kembali" type="tgl_kembali" autocomplete="tgl_kembali" value="{{ old('tgl_kembali') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                      </div>
                      <div class="mt-5 col-span-full gap-y-8">
