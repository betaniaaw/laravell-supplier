...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
 ...
 <form action="{{ route('barangkeluar.store') }}" method="POST">
   ...
   <div class="border-b border-gray-900/10 pb-12">
     <h2 class="text-base/7 font-semibold text-gray-900">Add outgoing item data</h2>
            ...
            <label for="lokasi" class="block text-sm/6 font-medium text-gray-900">Lokasi</label>
              ...
              <div class="mt-5 col-span-full gap-y-8">
                <label for="penerima" class="block text-sm/6 font-medium text-gray-900">Penerima</label>
                  <div class="mt-2">
                    <input id="penerima" name="penerima" type="penerima" autocomplete="penerima" value="{{ old('penerima') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                  </div>
        </div>
    </div>
